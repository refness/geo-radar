...
function initMap() {
  ...
  // Leaflet 1.9.4+ bakes a small Ukraine-flag-colored icon into the default
  // attribution prefix (blue/yellow stripes, a show of support added by the
  // Leaflet team) — override it with a plain neutral white square instead,
  // without touching the vendored library file itself.
  map.attributionControl.setPrefix(
    ...
    '<rect width="12" height="8" fill="#ffffff"/></svg> Leaflet</a>'
  );
